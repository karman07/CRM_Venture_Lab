import { useIncubatorMentors } from '../context/IncubatorMentorsProvider';
...
const IncubatorMentorsPage = () => {
  const { mentors } = useIncubatorMentors();

  return (
     <MainLayout>
        <IncubatorMainLayout>
    <div className="max-w-7xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-6 text-slate-800">Our Incubator Mentors</h1>
...
export default IncubatorMentorsPage;
